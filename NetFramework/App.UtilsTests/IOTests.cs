...
namespace App.Utils.Tests
{
    ...
    public class IOTests
    {
        ...
        {
            var name1 = IO.GetCache("Name", () => "Kevin");
            var name2 = IO.GetCache<string>("Name");
            Assert.AreEqual(name1, name2);

            IO.SetCache("Name", "John");
            var name3 = IO.GetCache<string>("Name");
            Assert.AreEqual(name3, "John");

            var p1 = IO.GetCache<Person>("Kevin", () => new Person("Kevin"));
            var p2 = IO.GetCache<Person>("Cherry", () => new Person("Cherry"));
