...
namespace App.Utils
{
    ...
    public class ThreadHelper
    {
        ...
        /// <summary>运行线程（带参数）</summary>
        public static void RunThread(Action<object> func, object p)
        {
            new Thread(new ParameterizedThreadStart(func)).Start(p);
        }
        ...
        public static void RunAndKeep(string exeFilePath, int sleep)
        {
